...
public class JsonMoveInventoryItemAction extends JsonAbstractTypedMessage {

	public static final String TYPE = "JsonMoveInventoryItemAction";

	long objectId;
	
	boolean dropItem = false;
	
	public JsonMoveInventoryItemAction() {
		setType(TYPE);
	}
	
	public JsonMoveInventoryItemAction(Map<?, ?> m) {
		setType(TYPE);
