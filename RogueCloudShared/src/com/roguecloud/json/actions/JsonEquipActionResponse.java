...
public class JsonEquipActionResponse extends JsonAbstractTypedMessage {
	
	public static final String TYPE = "JsonEquipActionResponse";
	...
	public JsonEquipActionResponse(JsonActionMessageResponse o) {
		setType(TYPE);
