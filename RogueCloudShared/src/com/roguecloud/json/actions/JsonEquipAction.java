...
public class JsonEquipAction extends JsonAbstractTypedMessage {

	public static final String TYPE = "JsonEquipAction"; 

	private long objectId;
	
	public JsonEquipAction(Map<?, ?> m) {
		setType(TYPE);
		objectId = RCRuntime.convertToLong(m.get("objectId"));
	}
	
	public JsonEquipAction() {
		setType(TYPE);
	}
